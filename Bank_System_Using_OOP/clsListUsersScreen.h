 ...
 public:
	 ...
	 static void Show()
	 {
		 ...
		 else
		 {
			 ...
			 cout << "|________________|_____________|___________________|___________________|___________________|________________________________|______________\n";
